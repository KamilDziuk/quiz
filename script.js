function submitAnswers() {
    var a1 = document.querySelector('input[name="a1"]:checked').value;
    var b1 = document.querySelector('input[name="b1"]:checked').value;
    var c1 = document.querySelector('input[name="c1"]:checked').value;
    var d1 = document.querySelector('input[name="d1"]:checked').value;
    var e1 = document.querySelector('input[name="e1"]:checked').value;
    var f1 = document.querySelector('input[name="f1"]:checked').value;
